"C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\MSBuild\15.0\Bin\MSBuild.exe" "./ASCOM.Sony.Camera.sln" /p:configuration=debug /property:Platform="Any CPU" /t:Clean,Build
