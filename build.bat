"C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\MSBuild\Current\Bin\MSBuild.exe" "./ASCOM.Sony.Camera.sln" /p:configuration=debug /property:Platform="Any CPU"
